...
//     $id = 96;
//     $data = \App\Profile::where("user_id",26)->first()->saved_jobs;
...
Route::post("/user-login","Auth\LoginController@customLogin");
Route::post("/send-verification-code", "Auth\LoginController@resendVerificationCode");
Route::post("/verify-code","Auth\LoginController@verifyCode");

Route::post('/consult','ConsultController@sendMail')->name('consult');
Route::get('page/uber-uns', 'ArticleController@aboutPage')->name('main.about');
...
// Category Login
Route::post('/login-from-category','Auth\LoginController@ctgLogin');
...
Route::group(
    ...
    function () {
        ...
        Route::post("/employer/delete-job","JobController@deleteJob");

        Route::post('/employer/complete-job',"JobController@completeJob");
...
Route::group(
    ...
    function () {
        ...
        Route::get("/user-notifications","UserController@userNotification");

        Route::post('/user-has-seen-notification',"UserController@makeNotificationSeen");


        // Get User Messages
        Route::get("/get-conversations","ConversationController@getConversation");
        // End
...
// Custom messages
Route::get("/message-center", "MessageController@index")->name("message");
Route::get("/message-center/t/{any}","MessageController@index")->where("any",".*");
...
Route::post("/send-my-message","ConversationController@send");
// End
// #####################
