                ...
                <div class="wt-insightsitemholder">
                    ...
                    <div class="row">
                        ...
                        @if ($access_type == 'jobs' || $access_type== 'both')
                            ...
                            {{-- <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                                <div class="card card-hover {{ $notify_class }}">
                                    <div class="card-body text-center">
                                        <figure class="wt-userlistingimg">
                                        ...
                                        <h3 class="wt-title">{{{ Helper::getTotalProposalsByStatus($freelancer_id, 'cancelled') }}}</h3>
                                        <h3 class="wt-title">{{ trans('lang.total_cancelled_projects') }}</h3>
                                        <a href="{{{ url('freelancer/jobs/cancelled') }}}" class="btn btn-sm btn-primary">{{ trans('lang.click_view') }}</a>
                                    </div>
                                </div>
                            </div> --}}
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3 mb-3">
                                <div class="card {{ $notify_class }}">
                                    <div class="card-body text-center">
                                        ...
                                        {{-- <p>{{{ Helper::getTotalProposalsByStatus($freelancer_id, 'hired') }}}</p> --}}
                                    </div>
                                </div>
                            </div>
