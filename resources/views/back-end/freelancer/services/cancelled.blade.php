...
<style>
	...
	<div class="wt-haslayout wt-dbsectionspace la-manage-jobs-holder">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 wt-insightsitemholder" id="services">
				...
				<div class="preloader-section" v-if="loading" v-cloak>
					...
					<div class="preloader-holder">
						...
						<div class="wt-dashboardbox wt-dashboardservcies">
							...
							<div class="wt-dashboardboxtitle wt-titlewithsearch border-0 pb-0">
																...
																<div class="wt-userlistingcontent">
																	...
																	<div class="wt-title">
																		...
																		<a href="{{{url('profile/'.$freelancer->slug)}}}">
																			...
																			<i class="material-symbols-outlined">verified</i> {{{Helper::getUserName($freelancer->id)}}}
