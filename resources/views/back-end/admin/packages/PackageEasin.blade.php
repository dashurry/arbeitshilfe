                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-4 float-left">
                    ...
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            ...
                            <form action="{{ url("admin/store/package") }}" class="wt-formtheme wt-packagesform" method="POST">
                                @csrf
                                <fieldset>
                                    <div class="form-group">
                                        <input type="text" class="form-control @if($errors->has("package_title")) is-invalid @endif" placeholder="{{ trans("lang.ph_pkg_title") }}" name="package_title">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="package_subtitle" placeholder="{{ trans("lang.ph_pkg_subtitle") }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control  @if($errors->has("package_price")) is-invalid @endif" name="package_price" placeholder="{{ trans("lang.ph_pkg_price") }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="wt-select">
                                            ...
                                            <select name="roles" v-model="user_role" v-on:change="selectedRole(user_role)" class="form-control {{ $errors->has('roles') ? ' is-invalid' : '' }}">
                                    ...
                                    <div class="form-group wt-btnarea">
                                        ...
                                        <button class="wt-btn" type="submit">{{ trans("lang.add_packages") }}</button>
                            ...
                            {{-- {!! Form::open([ 'url' => url('admin/store/package'), 'class' =>'wt-formtheme wt-packagesform', 'id' => 'packages', 
                            '@submit.prevent' => 'submitPackage', 'id' => 'package_form' ]) !!}
