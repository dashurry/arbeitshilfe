                ...
                <div class="wt-dashboardbox">
                    ...
                    <div class="sj-checkoutjournal">
                        ...
                        <div class="wt-dashboardboxcontent wt-oderholder">
                            ...
                            <table class="sj-checkouttable wt-ordertable table table-hover">

                                <thead class="thead-dark">

                                    <tr>

                                        <th class="col text-white border-0">{{ trans('lang.item_title') }}</th>

                                    <th class="col text-white border-0">{{trans('lang.details')}}</th>
