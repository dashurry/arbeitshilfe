                                        ...
                                        <div class="wt-userlistingcontent">
                                            ...
                                            <div class="wt-contenthead">
                                                ...
                                                <div class="wt-title">
                                                    ...
                                                    <a href="{{{ url('profile/'.$job->employer->slug) }}}">@if($verified_user === 1)<i class="material-symbols-outlined">verified</i>@endif {{{$job->employer->first_name.' '.$job->employer->last_name}}}</a>
