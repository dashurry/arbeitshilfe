				...
				<div class="wt-dashboardbox">
                    ...
                    @if (!empty($proposals))
                        ...
                        <div class="wt-dashboardboxcontent wt-rcvproposala">
                            ...
                            <div class="wt-userlistinghold wt-userlistingvtwo {{ $feature_class }} card shadow-none">
                                ...
                                <div class="wt-userlistingcontent">
                                    ...
                                    <div class="row">
                                            ...
                                            @if (!empty($user_name) || !empty($job->title) )
                                                ...
                                                <div class="wt-title">
                                                    ...
                                                    @if (!empty($user_name))
                                                        ...
                                                        <a class="d-flex align-items-center" href="{{{ url('profile/'.$job->employer->slug) }}}">@if($verified_user === 1)<i class="material-symbols-outlined">verified</i>@endif&nbsp;{{{ $user_name }}}</a>
                                            ...
                                            @if (!empty($job->professional_level) ||
                                                ...
                                                <ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
                                                    ...
                                                    @if (!empty($job->price))
                                                        ...
                                                        <li>
                                                            ...
                                                            <span class="d-flex align-items-center">
                                                                ...
                                                                <i class="material-symbols-outlined mr-2">payments</i>
                                                                 {{{ $job->price }}}
                                                            </span>
                                                        </li>
                                                    ...
                                                    @if (!empty($job->location->title))
                                                        ...
                                                        <li>
                                                            <span class="d-flex align-items-center">
                                                                {{-- <img src="{{{asset(App\Helper::getLocationFlag($job->location->flag))}}}" alt="{{ trans('lang.img') }}"> --}}
                                                                <i class="material-symbols-outlined mr-2">location_on</i>{{{ $job->location->title }}}
                                                            </span>
                                                        </li>
                                                    ...
                                                    @if (!empty($job->duration) && !is_array($duration))
                                                        ...
                                                        <li>
                                                            <span class="wt-dashboradclock d-flex align-items-center">
                                                                <i class="material-symbols-outlined mr-2">schedule</i>
                                                                {{-- {{ trans('lang.duration') }} --}}
                                                                {{{ $duration }}}
                                                            </span>
                                                        </li>
                                        ...
                                        <div class="wt-rightarea col-3 border-left d-flex align-items-cente">
