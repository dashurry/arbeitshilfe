                                                                        ...
                                                                        <div class="wt-title">
                                                                            ...
                                                                            @if (!empty($user_name))
                                                                                ...
                                                                                <a href="{{{ url('profile/'.$job->employer->slug) }}}">
                                                                                    ...
                                                                                    @if($job->employer->user_verified === 1)<i class="material-symbols-outlined">verified</i>{{{ $user_name }}} @endif
                                                                        ...
                                                                        <div class="wt-contenthead wt-followcomhead">
                                                                            ...
                                                                            <div class="row justify-content-center">
                                                                                ...
                                                                                <ul class="wt-followcompomy-breadcrumb wt-userlisting-breadcrumb pb-5 pr-3">
                                                                                    ...
                                                                                    <li><a class="btn btn-outline-dark shadow-none lift" href="{{{ url('profile/'.$user->slug) }}}"> {{ trans('lang.open_jobs') }}  </a></li>

                                                                                    <li><a class="btn btn-outline-dark shadow-none lift" href="{{ url('profile/'.$user->slug) }}"> {{ trans('lang.full_profile') }}</a></li>
