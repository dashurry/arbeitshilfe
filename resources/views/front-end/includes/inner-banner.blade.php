...
@else
    ...
    @if (!empty($show_banner) && $show_banner == 'true')
        ...
        <div class="wt-haslayout wt-innerbannerholder" style="background: #f9fcff">
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
                        ...
                        <div class="wt-innerbannercontent">
                            ...
                            <div class="wt-title">
                                <h2>
                                    <span class="text-underline-warning" style="background-image: linear-gradient(90deg, rgba(245, 192, 112, 0.4), rgba(245, 192, 112, 0.4));">{{ $title }}</span>
                                </h2>
                            </div>

                            @if (!empty($show_breadcrumbs) && $show_breadcrumbs === 'false')
