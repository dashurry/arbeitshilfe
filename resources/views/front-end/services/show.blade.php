                ...
                <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                        ...
                        <div class="wt-usersingle wt-servicesingle-holder">
                            ...
                            <div class="wt-servicesingle card">
                                ...
                                <div class="wt-servicesingle-title">
                                    ...
                                    <ul class="wt-userlisting-breadcrumb" style="line-height:2;">

                                        <li>

                                            <span class="d-flex align-items-center">
                                                
                                                <i class="material-symbols-outlined iconcolor3 mr-2">star</i>

                                                {{{ $rating }}}/<span>5</span>&nbsp;({{{ !empty($reviews) ? $reviews->count() : ''}}} {{ trans('lang.feedbacks') }})
                                        ...
                                        <li>
                                            ...
                                            <span class="d-flex align-items-center">
                                                ...
                                                @if ($total_orders > 0)
                                                    ...
                                                    <i class="material-symbols-outlined fa-spin">autorenew</i>
                            ...
                            <div class="wt-clientfeedback card">

                                {{-- <div class="wt-usertitle wt-titlewithselect"> --}}
                                <div class="wt-titlewithselect">

                                    <h2 class="h2">{{ trans('lang.reviews') }}</h2>
