                                                ...
                                                <div class="wt-contenthead">
                                                    ...
                                                    <div class="wt-title">
                                                        ...
                                                        @if (!empty($job->employer->slug))
                                                            ...
                                                            <a href="{{ url('profile/'.$job->employer->slug) }}"><i class="material-symbols-outlined">verified</i> {{{ Helper::getUserName($job->employer->id) }}}</a>
                                                ...
                                                <div class="wt-viewjobholder">
                                                    ...
                                                    <ul>
                                                        ...
                                                        @if (!empty($job->location->title))
                                                            ...
                                                            <li><span><i class="fas fa-map-marker-alt wt-viewjobfolder"></i>{{{ $job->location->title }}}</span></li>
