...
.tg-qrcodedetail .material-symbols-outlined{
    ...
    <div class="wt-haslayout wt-innerbannerholder wt-innerbannerholdervtwo"
     {{-- style="background-image: url({{{ asset(Helper::getUserProfileBanner($user->id)) }}});" --}}
     >
        ...
        @if ($display_chat == 'true')
            ...
            @if (Auth::user())
                ...
                @if ($profile->user_id != Auth::user()->id)
                    ...
                    <chat :trans_image_alt="'{{trans('lang.img')}}'" :ph_new_msg="'{{ trans('lang.ph_new_msg') }}'" 
                    :trans_placeholder="'{{ trans('lang.ph_type_msg') }}'" :receiver_id="'{{$profile->user_id}}'" 
                    :receiver_profile_image="'{{ asset(Helper::getProfileImage($user->id)) }}'"></chat>
                                ...
                                <div class="wt-userprofile">
                                    ...
                                    @if (!empty($avatar))
                                        ...
                                        <figure>
                                            ...
                                            <img src="{{{ asset($avatar) }}}" alt="{{{ trans('lang.user_avatar') }}}">

                                        </figure>

                                        <figure>

                                            <img src="{{{ asset(Helper::getImage('uploads/users/' . $profile->user_id,$profile->avater, '' , 'user.jpg')) }}}" alt="{{{ trans('lang.user_avatar') }}}">

                                        </figure>

                                    @endif
                                        
                                    <div class="wt-title d-flex flex-column">

                                        <figure class="freelancers-img-profile">
                                        ...
                                        <ul class="wt-userlisting-breadcrumb wt-userlisting-breadcrumbvtwo">
                                            ...
                                            @if (!empty($profile->hourly_rate))
                                                ...
                                                <li>
                                                    <span class="d-flex align-items-center">
                                                        <i class="material-symbols-outlined pr-1">payments</i>
                                                        {{ $symbol }}{{{ $profile->hourly_rate }}} {{{ trans('lang.per_hour') }}}
                                                    </span>
                                                </li>
                                            ...
                                            @if (!empty($user->location->title))
                                                ...
                                                <li>
                                                    ...
                                                    <span>
                                                        ...
                                                        {{-- <img src="{{{asset(Helper::getLocationFlag($user->location->flag))}}}" alt="{{{ trans('lang.flag_img') }}}"> --}} 
                                                        {{{ $user->location->title }}}
                                            ...
                                            @if (in_array($profile->id, $save_freelancer))
                                                ...
                                                <li class="wt-btndisbaled">
                                                    ...
                                                    <a href="javascrip:void(0);" class="wt-clicksave wt-clicksave d-flex align-items-center">

                                                        <i class="material-symbols-outlined pr-1">favorite</i>
                                            ...
                                            @else
                                                ...
                                                <li v-bind:class="disable_btn" v-cloak>
                                                    ...
                                                    <a href="javascrip:void(0);" v-bind:class="click_to_save" class="d-flex align-items-center" id="freelancer-{{$profile->id}}" @click.prevent="add_wishlist('freelancer'-{{$profile->id}}, {{$profile->id}}, 'saved_freelancer', '{{trans("lang.saved")}}')" v-cloak>
                                ...
                                <div class="col-5 pr-0">
                                    ...
                                    <div id="wt-statistics" class="wt-statistics wt-profilecounter">
                                        ...
                                        <div class="wt-description">
                                            ...
                                            <a href="javascript:void(0);" @click.prevent='sendOffer("{{$auth_user}}")' class="btn btn-success shadow-none mb-5 lift">{{{ trans('lang.btn_send_offer') }}}</a>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 float-left">
                            ...
                            <div class="wt-services-holder">
                                ...
                                <div class="mt-4 ml-4 mb-4">
                                    ...
                                    <h2 class="h2">{{ trans('lang.services') }}</h2>
                                                    ...
                                                    <div class="wt-freelancers-details">
                                                        ...
                                                        <div class="wt-freelancers-content">
                                                            ...
                                                            <div class="dc-title">
                                                                ...
                                                                <a href="{{{ url('profile/'.$user->slug) }}}" class="d-flex align-items-center"><i class="material-symbols-outlined">verified</i> {{{Helper::getUserName($user->id)}}}</a>
                        ...
                        <div class="wt-usersingle">
                            ...
                            <div class="wt-clientfeedback la-no-record">
                                ...
                                <div class="mt-4 ml-4 mb-4">
                                    ...
                                    <h2 class="h2">{{ trans('lang.client_feedback') }}</h2>
                                                    ...
                                                    <div class="wt-userlistingcontent">
                                                        ...
                                                        <div class="wt-contenthead">
                                                            ...
                                                            <div class="wt-title">
                                                                ...
                                                                <a href="{{{ url('profile/'.$job->employer->slug) }}}">@if ($user->user_verified === 1)<i class="material-symbols-outlined">verified</i>@endif {{{ Helper::getUserName($review->user_id) }}}</a>
                                                        ...
                                                        <div class="wt-userlistingcontent">
                                                            ...
                                                            <div class="wt-contenthead">
                                                                ...
                                                                <div class="wt-title">
                                                                    ...
                                                                    <a href="{{{ url('profile/'.$user->slug) }}}">@if ($user->user_verified == 1)<i class="material-symbols-outlined">verified</i>@endif {{{ Helper::getUserName($review->user_id) }}}</a>
                            ...
                            <div class="wt-craftedprojects">
                                ...
                                <div class="mt-4 ml-4 mb-4">
                                    ...
                                    <h2 class="h2">{{{ trans('lang.crafted_projects') }}}</h2>
                            ...
                            @if (!empty($videos))
                                ...
                                <div class="wt-videos">
                                    ...
                                    <div class="mt-4 ml-4 mb-4">
                                        ...
                                        <h2 class="h2">{{{ trans('lang.videos') }}}</h2>
                            ...
                            <div class="wt-experience">
                                ...
                                <div class="mt-4 ml-4 mb-4">
                                    ...
                                    <h2 class="h2">{{{ trans('lang.experience') }}}</h2>
                            ...
                            <div class="wt-experience wt-education">
                                ...
                                <div class="mt-4 ml-4 mb-4">
                                    ...
                                    <h2 class="h2">{{{ trans('lang.education') }}}</h2>
                        ...
                        <aside id="wt-sidebar" class="wt-sidebar">
                            ...
                            <div id="wt-ourskill" class="wt-widget">
                                ...
                                <div class="mb-4">
                                    ...
                                    <h2 class="h2">{{ trans('lang.my_skills') }}</h2>
                            ...
                            <div class="wt-widget wt-sharejob">
                                ...
                                <div class="mb-4">
                                    ...
                                    <h2 class="h2">{{ trans('lang.share_freelancer') }}</h2>
                                    <hr>
                            ...
                            <div class="wt-widget wt-reportjob">
                                ...
                                <div class="mb-4">
                                    ...
                                    <h2 class="h2">{{ trans('lang.report_user') }}</h2>
                                    <hr>
                                    ...
                                    {!! Form::open(['url' => '', 'class' =>'wt-formtheme wt-formreport', 'id' => 'submit-report',  '@submit.prevent'=>'submitReport("'.$profile->user_id.'","freelancer-report")']) !!}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group wt-btnarea">
                                                ...
                                                {!! Form::submit(trans('lang.btn_submit'), ['class' => 'btn btn-success lift shadow-none']) !!}
                    ...
                    <div class="wt-formtheme wt-formpopup">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                {{{ Form::textarea('desc', null, array('class' => 'form-control','placeholder' => trans('lang.ph_add_desc'))) }}}
                            ...
                            <div class="form-group wt-btnarea">
                                ...
                                {!! Form::submit(trans('lang.btn_send_offer'), ['class' => 'btn btn-success lift shadow-none']) !!}
...
@push('scripts')
    ...
    <script>
        ...
        _wt_freelancerslider.owlCarousel({
            ...
            navText: ['<span class="lnr lnr-chevron-left"></span>', '<span class="material-symbols-outlined">keyboard_arrow_right</span>'],
