...
<section class="position-relative mb-md-5 py-lg-0 py-md-5 py-5">
    ...
    <div class="container-fluid pr-lg-0 jarallax" data-jarallax data-type="scale-opacity" data-speed="0.25">
      <div class="row no-gutters">
        ...
        <!-- Content -->
        <div class="col-md-12 order-md-1 order-2 align-self-center d-flex justify-content-center mt-xl-n5 py-lg-6 text-md-left text-center">
          <div class="pb-3 py-md-6">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-alt breadcrumb-light justify-content-center mb-sm-4">
                  ...
                  <li class="breadcrumb-item active text-dark" aria-current="page">Dienstleistungen</li>
              </ol>
          </nav>
            {{-- Categories --}}
