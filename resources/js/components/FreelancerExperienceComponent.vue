<template>
    <div>
            ...
            <div class="wt-experiencelisting wt-bgcolor" v-if="experiences[index]">
                ...
                <div class="wt-experiencecontent">
                    <ul class="wt-userlisting-breadcrumb">
                        <li v-if="experiences[index]">
                            <span class="d-flex align-items-center">
                                <i class="material-symbols-outlined mr-2" style="font-size:18px;">home_work</i>
                                 {{experiences[index].company_title}}
                            </span>
                        </li>
                        <li v-if="experiences[index]">
                            <span class="d-flex align-items-center">
                                <i class="material-symbols-outlined mr-2" style="font-size:18px;">date_range</i> 
                                {{experiences[index].start_date}} - {{experiences[index].end_date}}
                            </span>
                        </li>
                    </ul>
        ...
        <div class="wt-btnarea">
            ...
            <a href="javascript:void(0);" class="btn btn-success lift shadow-none"  @click="commentsToShow += 3" v-if="commentsToShow < experiences.length">
