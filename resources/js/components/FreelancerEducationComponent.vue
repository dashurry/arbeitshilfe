    ...
    <div>
        <div class="wt-experiencelisting-hold" v-for="(commentIndex, index) in commentsToShow" :key="index" v-if="educations[index]">
            <div class="wt-experiencelisting wt-bgcolor">
                ...
                <div class="wt-experiencecontent" v-if="educations[index]">
                    <ul class="wt-userlisting-breadcrumb">
                        <li><span class="d-flex align-items-center">
                            <i class="material-symbols-outlined mr-2" style="font-size:18px;">school</i> 
                            {{ educations[index].institute_title }}
                            </span>
                        </li>
                        <li>
                            <span class="d-flex align-items-center">
                                <i class="material-symbols-outlined mr-2" style="font-size:18px;">date_range</i> 
                                {{ educations[index].start_date }} - {{ educations[index].end_date }}
                            </span>
                        </li>
                    </ul>
            ...
            <div class="wt-btnarea">
                ...
                <a href="javascript:void(0);" class="btn btn-success lift shadow-none"  @click="commentsToShow += 3" v-if="commentsToShow < educations.length">
