        ...
        DB::table('email_templates')->insert(
            ...
            [
                ...
                [
                    ...
                    'content' => '<p>Hi <strong>%name%!</strong> Thanks for registering at Arbeitshilfe. You can now login to manage your account using the following credentials:<br /> <strong>Username:</strong> %name%<br /> <strong>Password:</strong> %password%<br /> <strong>Email:</strong> %email%<br /> %signature%</p>',
                ...
                [
                    ...
                    'content' => '<p>Hi <strong>%name%!</strong> Thanks for registering at Arbeitshilfe.<br /> Here is your verification code to complete registration process<br /> <strong>Name :</strong> %name%<br /> <strong>Email :</strong> %email%<br /> <strong>Verification Code:</strong> %verification_code%<br /> %signature%</p>',
