            ...
            if (!empty($request)) {
                ...
                if (!empty($payment_settings) && $package_status === 'true') {
                    ...
                    if ($submit_propsal = 'success') {
                        ...
                        $notification->body = '<p class="user-name">' . Auth::user()->first_name . " " . Auth::user()->last_name . '</p>
                        ...
                        broadcast(new \App\Events\UserNotification(array(
                            "send_notification_to" => $job->user_id,
                            "data" => $notification
                        )));
