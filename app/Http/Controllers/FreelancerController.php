...

{
...

    {
        ...
        $dateOfBirth = !empty($profile->dateOfBirth) ? $profile->dateOfBirth : '';
...

    {
        ...
        $this->validate(
            ...
            [
                "dateOfBirth.before" => "Mindestalter von 18 Jahren erforderlich"
            ]
...

    {
        ...
        $proposals = Proposal::select('*')->where('freelancer_id', Auth::user()->id)->latest()->paginate(7);
