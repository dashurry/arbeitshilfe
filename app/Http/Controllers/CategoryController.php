...

{
...

    {
        ...
        if (!empty($id)) {
            ...
            if(file_exists(public_path("uploads/categories/$data->image")))
            {
                unlink(public_path("uploads/categories/$data->image"));
            }

            // Delete small file
            if (file_exists(public_path("uploads/categories/small-$data->image"))) {
                unlink(public_path("uploads/categories/small-$data->image"));
            }

            // Delete medium file
            if (file_exists(public_path("uploads/categories/medium-$data->image"))) {
                unlink(public_path("uploads/categories/medium-$data->image"));
            }
