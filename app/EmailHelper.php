...

{
...

    {
        ...
        $email = !empty($setting) && !empty($setting[0]['from_email']) ? $setting[0]['from_email'] : 'hello@maurofrappietro.com';
...

    {
        ...
        $email_id = !empty($setting) && !empty($setting[0]['from_email_id']) ? $setting[0]['from_email_id'] : 'hello@maurofrappietro.com';
