...

{
...

    {
        ...
        if (!empty($request)) {
            ...
            $this->has_3d_icon = $request["3d"]=='on'?1:0;
            ...
            if (!empty($request['uploaded_image'])) {
                ...
                if (file_exists($old_path . '/' . $request['uploaded_image'])) {
                    ...
                    if (file_exists($old_path . '/small-' . $request['uploaded_image']))
                    {
                        rename($old_path . '/small-' . $request['uploaded_image'], $new_path . '/small-' . $filename);
                    }
                    
                    if(file_exists($old_path . '/medium-' . $request['uploaded_image']))
                    {
...

    {
        ...
        if (!empty($request)) {
            ...
            $cats->has_3d_icon = $request["3d"]=='on'?1:0;
